        ...
        {data.length === 0 && fetched ? (
          <>
            <div style={{ textAlign: 'center', marginTop: '10vh' }}>
              ...
              <div style={{ marginTop: '2vh', fontWeight: 'bold', fontSize: '16px', opacity: '0.7' }}>Your bookshelf's feeling hungry! Why not feed it a book? Just hit 'CREATE' up top right!</div>
            </div>
          </>
        ) : (
